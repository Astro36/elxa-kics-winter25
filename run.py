...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ElxaTST")

    # basic config
    parser.add_argument("--task_name", type=str, required=True, default="long_term_forecast", help="task name, options:[long_term_forecast]")
    ...
    parser.add_argument(
        "--features", type=str, default="M", help="forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate"
    )
    ...
    parser.add_argument("--percent_dy", type=float, default=0.2)
    parser.add_argument("--percent_dx", type=float, default=0.2)
    parser.add_argument("--top_sk", type=int, default=20)
    parser.add_argument("--cross_axis_patch_sampling_ratio", type=int, default=20)
    parser.add_argument("--top_dk", type=bool, default=True)
    parser.add_argument("--kernel_size", type=int, default=25)
    parser.add_argument("--revin", type=bool, default=True)
    parser.add_argument("--affine", type=bool, default=False)
    parser.add_argument("--subtract_last", type=bool, default=False)
    ...
    if args.task_name == "long_term_forecast":
        ...
        raise RuntimeError(f"task_name should be long_term_forecast/short_term_forecast, not {args.task_name}")
